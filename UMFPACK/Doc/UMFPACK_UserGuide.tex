...
Copyright\copyright 1995-2018 by Timothy A. Davis.
All Rights Reserved.
...
and the shared libraries ({\tt *.so} on Linux/Unix or {\tt *.dylib} on the Mac).
...
\item {\tt -DNRECIPROCAL} controls a trade-off between speed and accuracy.
    ...
    When compiling the complex routines with the {\tt gcc} compiler, the
